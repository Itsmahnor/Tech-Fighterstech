...
export const AboutMe = () => {
  return (
    <div className="w-[100vw] md:h-auto sm:h-auto pt-24  sm:pt-48 bg-gradient-to-r from-[#C19EE0] to-[#DAC3E8] flex justify-center text-black text-[1.2rem]  ">
      <div className="w-100 lg:mx-28 mx-13 h-auto flex flex-wrap">
        ...
        <div className="md:w-[50%] p-5 h-auto flex flex-col justify-center">
          ...
          <h1 className="md:w-[30vw] text-[3rem] font-bold text-black">
            Educated Over 10,000+ Students In Pakistan
          </h1>
          <p className="mt-2 text-[#4A4A4A]">
            Over 10,000 students have learned under my guidance, many of whom
            are now successfully employed across Pakistan. I have also completed
            200+ projects and collaborated with industry experts.
          </p>
          ...
          <div className="flex gap-2 items-center">
            ...
            <p className="mt-3 text-black">Over 200+ successful projects</p>
          </div>
          <div className="flex gap-2 items-center">
            <div className="bg-gradient-to-r from-[#A06CD5] to-[#9163CB] rounded-full flex items-center justify-center">
              <BsArrowRightCircle className="text-black" />
            ...
            <p className="mt-3 text-black">
              Industry collaboration with experts
            </p>
          </div>
