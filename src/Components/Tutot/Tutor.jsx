...
const HeaderSection = () => (
  <div>
    <p className="text-center animate text-black font-bold">
      EXPERT TECHFIGHTER TUTORS
    </p>
    ...
    {TutorData.map((item, index) => (
      <div key={index} className="px-2">
        ...
        >
          ...
          <p className="text-gray-600 font-bold mb-2 text-[1.2rem]">
            {item.subject}
          </p>
          <p
          ...
          <p className="text-gray-600 font-bold mb-3 text-[1.2rem]">
            {item.experience}
          </p>
          <div className="flex justify-center items-center mt-3">
            <span className="text-[#6247AA] text-[1.5rem] mx-1">
              <IoMdStar />
            </span>
            <span className="text-[#6247AA] text-[1.5rem] mx-1">
              <IoMdStar />
