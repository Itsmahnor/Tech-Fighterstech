...
const SignUp = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#C19EE0] overflow-hidden px-1 py-5">
          ...
          <div className="flex flex-col">
            <div className="flex items-center bg-white rounded-lg text-black px-4">
              ...
              <select
                ...
                onChange={handleChange}
                className="flex-grow py-2 overflow-hidden text-[0.6rem] sm:text-[1rem] bg-transparent placeholder-gray-500 focus:outline-none"
              >
