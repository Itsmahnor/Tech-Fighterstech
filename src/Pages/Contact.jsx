    ...
    if (validate()) {
      try {
        ...
        const response = await axios.post(
          `${window.location.origin}/api/con/Contact`,
          formData
        );
        setSuccessMessage(
    ...
    <div className="bg-[#C19EE0] text-black">
      ...
      <div className="breadcrumb-wrapper md:h-[50vh] flex justify-center items-center flex-col text-center py-12">
        <h1 className="text-black font-bold text-3xl mb-4">
          Get in Touch with TechFighters
        </h1>
        <p className="w-[70vw] text-black">
          At <span className="bg-[#A06CD5] text-black p-1">TechFighters</span>,
          we are always happy to hear from you! Whether you have questions about
          our courses, need support, or want to learn more about how we can help
          you achieve your educational goals, feel free to reach out. Our team
          ...
          <div className="flex flex-col md:flex-row items-center gap-16">
            ...
            <div className="w-full md:w-1/2">
              ...
              <p className="text-lg text-black mb-8">
                We work for the betterment of society by training its people in
                the field of Information Technology and other technologies. We
                aim to make this company an opportunity hub to reduce
                unemployment.
              </p>
              ...
              <p className="mb-4 text-black">
                9am - 9pm Monday-Thursday; Friday is closed.
              </p>
              <p className="mb-4 text-black">
                VIP Ghuri Town near by White Palace marquee Islamabad
              </p>
            ...
            <div className="w-full md:w-1/2">
              ...
              <form
                className="bg-[#A06CD5] p-6 rounded-lg shadow-md"
              ...
              >
                <div className="mb-4">
                  ...
                  />
                  {errors.name && (
                    <p className="text-black text-xs mt-1">{errors.name}</p>
                  )}
                </div>
                <div className="mb-4">
                  <label
                ...
                <div className="mb-4">
                  ...
                  ></textarea>
                  {errors.message && (
                    <p className="text-black text-xs mt-1">{errors.message}</p>
                  )}
                </div>
                <button
                ...
                {errors.form && (
                  <p className="text-black mt-4">{errors.form}</p>
                )}
                {successMessage && (
